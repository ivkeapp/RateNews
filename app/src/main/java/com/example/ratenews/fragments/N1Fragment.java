...
import com.example.ratenews.adapters.NewsAdapterN1;
 ...
 * {@link N1Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link N1Fragment#newInstance} factory method to
...
public class N1Fragment extends Fragment {
    ...
    public static N1Fragment newInstance(String param1, String param2) {
        N1Fragment fragment = new N1Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_n1, container, false);
        recyclerView = rootView.findViewById(R.id.recycler_view_n1);
        ...
        pullToRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                newsList.clear();
                new N1Fragment.FetchFeedTask().execute((Void) null);
    ...
    public class FetchFeedTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            progressBar.setVisibility(View.VISIBLE);
            urlLink = "http://rs.n1info.com/rss/250/Najnovije";
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                adapter = new NewsAdapterN1(newsList, getActivity());
        ...
        public List<RssFeedModel> parseFeed(InputStream inputStream) throws XmlPullParserException,
            ...
            try {
                ...
                while (xmlPullParser.next() != XmlPullParser.END_DOCUMENT) {
                    ...
                    //Log.e("sada1", "Parsing name ==> " + name + " " + isItem);
                    String result = "";
                    ...
                    if(isItem) {
                        if (name.equalsIgnoreCase("title")) {
                            //Log.e("title", "Result ==> " + result);
                            title = result;
                        } else if (name.equalsIgnoreCase("image")) {
                            img = result;
                        } else if (name.equalsIgnoreCase("description")) {
                            //Log.e("desc", "Result ==> " + result);
                            description = result;
                        } else if (name.equalsIgnoreCase("link")) {
                            link = result;
                        } else if (name.equalsIgnoreCase("pubDate")) {
                            Log.e("date1", "date "+result);
                            try {
                    ...
                    if (title != null && link != null && description != null && img != null && date != null) {
                        if(isItem) {
                            ...
                            mAPIService.getNews(link).enqueue(new Callback<Result>() {
                                ...
                                public void onResponse(Call<Result> call, Response<Result> response) {
                                    if(response.body().getSuccess()==1){
                                        ...
                                        Log.e("Checking N1", "Negative: " + item.getNegativeVotes() + ", Positive: "+item.getPositiveVotes());
                                    }
                                }
                                @Override
                            ...
                            //Log.e("n1parser", "Result ==> " + item.getTitle());
                            //Log.e("n1parser", "Result ==> " + item.getDescription());
                            items.add(item);
                        }
                        else {
                            //to-do
