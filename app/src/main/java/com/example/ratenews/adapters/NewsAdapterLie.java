...
public class NewsAdapterLie extends RecyclerView.Adapter<NewsAdapterLie.NewsViewHolder>{

    private List<AllNewsModel> bookList;
    private Context mContext;

    public NewsAdapterLie(List<AllNewsModel> bookList, Context mContext) {
    ...
    public void onBindViewHolder(final NewsViewHolder holder, final int position) {
        ...
        if(LieFragment.newsList.get(holder.getAdapterPosition()).isTrueBtnClicked){
        ...
        }else if(LieFragment.newsList.get(holder.getAdapterPosition()).isLieBtnClicked){
...
//        }, null);
    ...
    private void isPositiveBtnClicked(NewsViewHolder holder){
        LieFragment.newsList.get(holder.getAdapterPosition()).setTrueBtnClicked(!LieFragment.newsList.get(holder.getAdapterPosition()).isTrueBtnClicked);
        notifyDataSetChanged();
    ...
    private void isNegativeBtnClicked(NewsViewHolder holder){
        LieFragment.newsList.get(holder.getAdapterPosition()).setLieBtnClicked(!LieFragment.newsList.get(holder.getAdapterPosition()).isLieBtnClicked);
        notifyDataSetChanged();
    }
